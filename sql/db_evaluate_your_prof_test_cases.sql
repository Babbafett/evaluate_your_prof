...
Insert into t_evaluation(e_course,e_prof,e_overall,e_contentual,e_eloquence,e_motivation_prof,e_motivation_before,e_motivation_after,e_test_requirement,e_media_usage,e_soft_skills,e_hot,e_comment_positive,e_comment_negative,e_comment, e_competence) values(1,1,10,10,10,10,10,10,10,10,10,1,'test_positive','test_negative','test',10);
