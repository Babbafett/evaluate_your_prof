...
Insert into t_prof(p_lastname,p_forname,p_token, p_title) values('p_test_lastname2','p_test_forname2','ti','Dr.re.nat');
...
Insert into t_prof(p_lastname,p_forname,p_token, p_title) values('p_test_lastname3','p_test_forname3','tr','Dr.re.nat');
