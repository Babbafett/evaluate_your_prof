...
Insert into t_evaluation(e_course,e_prof,e_overall,e_contentual,e_eloquence,e_motivation,e_test_requirement,e_media_usage,e_soft_skills,e_hot) values(1,1,10,10,10,10,10,10,10,1);
Insert into t_evaluation(e_course,e_prof,e_overall,e_contentual,e_eloquence,e_motivation,e_test_requirement,e_media_usage,e_soft_skills,e_hot) values(1,1,1,1,1,1,1,1,1,2);
